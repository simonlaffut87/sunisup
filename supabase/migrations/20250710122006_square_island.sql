/*
  # Ajouter les champs manquants à la table participants

  1. Nouveaux champs
    - `email` (text) - Adresse email du participant
    - `ean_code` (text) - Code EAN unique
    - `commodity_rate` (numeric) - Tarif de commodité
    - `entry_date` (date) - Date d'entrée dans la communauté
