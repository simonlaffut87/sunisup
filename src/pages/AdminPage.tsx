            ...
            <div className="flex items-start space-x-8">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-3xl font-bold text-gray-900">{t('howToJoin.steps.documents.title')}</h3>
                </div>
            ...
            <div className="flex items-start space-x-8">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-3xl font-bold text-gray-900">{t('howToJoin.steps.membership.title')}</h3>
                </div>
                <ul className="space-y-4">
            ...
            <div className="flex items-start space-x-8">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-3xl font-bold text-gray-900">{t('howToJoin.steps.financial.title')}</h3>
                </div>
                <ul className="space-y-4">
            ...
            <div className="flex items-start space-x-8">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-3xl font-bold text-gray-900">{t('howToJoin.steps.activation.title')}</h3>
                </div>
                <ul className="space-y-4">
