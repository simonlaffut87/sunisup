        ...
        <section className="py-32 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
              ...
              {/* Service 2: Optimisation de votre situation énergétique */}
              <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-3xl p-10 border border-emerald-100 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-emerald-600" />
                    <span className="text-gray-700 font-sans">Négociation de tarifs groupés avantageux</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-emerald-600" />
                    <span className="text-gray-700 font-sans">Accompagnement dans le changement de fournisseur</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-emerald-600" />
                    <span className="text-gray-700 font-sans">Suivi régulier et optimisation continue</span>
                  </div>
                </div>
              ...
              {/* Service 3: Étude de rentabilité */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative max-w-4xl mx-auto">
              <div className="relative aspect-square max-w-xl mx-auto">
                ...
                {/* Flèches pointant vers les 3 services */}
            ...
            <div className="text-center mt-16">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 max-w-3xl mx-auto">
                ...
                <p className="text-gray-700 text-lg leading-relaxed font-sans font-light">
                  Nos trois services se complètent pour offrir une solution énergétique complète. Que vous souhaitiez rejoindre notre communauté d'énergie, optimiser votre situation énergétique actuelle ou étudier l'installation de panneaux solaires, nous vous accompagnons à chaque étape de votre transition énergétique.
                </p>
              </div>
            </div>
          </div>
