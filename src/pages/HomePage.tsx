              ...
              <div className="bg-white rounded-lg p-8 border border-teal-100 hover:border-teal-200 transition-all duration-200 hover:shadow-md">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    ...
                    className="bg-white hover:bg-teal-50 text-brand-teal border border-brand-teal/30 px-5 py-2.5 rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-2 font-sans"
                  >
            ...
            <div className="relative max-w-4xl mx-auto px-4">
              <div className="relative aspect-square max-w-xl mx-auto scale-75 sm:scale-75 lg:scale-100">
                ...
                <svg className="absolute inset-0 w-full h-full" viewBox="0 0 300 300">
                  ...
                  <line x1="150" y1="130" x2="150" y2="85" stroke="#000000" strokeWidth="3" markerEnd="url(#arrowhead)" />
                  <line x1="170" y1="150" x2="215" y2="150" stroke="#000000" strokeWidth="3" markerEnd="url(#arrowhead)" />
                  <line x1="150" y1="170" x2="150" y2="215" stroke="#000000" strokeWidth="3" markerEnd="url(#arrowhead)" />
                  <line x1="130" y1="150" x2="85" y2="150" stroke="#000000" strokeWidth="3" markerEnd="url(#arrowhead)" />
                </svg>
              </div>
            </div>
