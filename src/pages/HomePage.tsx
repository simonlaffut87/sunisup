            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-10 border border-blue-100 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
                <div className="flex items-center mb-8">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-2 font-sans">Communauté d'énergie</h3>
                ...
                <p className="text-gray-700 text-lg leading-relaxed mb-8 font-sans font-light">
                  Rejoignez notre communauté mère composée de producteurs et consommateurs qui comptabilisent aujourd'hui 1.4 GWh d'énergie disponible et 1.5 GWh de consommation annuelle et profitez d'un tarif stable à 40% des tarifs du marché.
                </p>
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-3xl p-10 border border-emerald-100 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
                <div className="flex items-center mb-8">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-2 font-sans">Sous-communauté</h3>
                    <div className="w-12 h-1 bg-gradient-to-r from-emerald-500 to-green-600 rounded-full"></div>
                  </div>
                </div>
                <p className="text-gray-700 text-lg leading-relaxed mb-8 font-sans font-light">
                  Profitez de notre structure et nos conseils pour mettre en place un partage d'énergie entre vos bâtiments uniquement.
                </p>
                
                <div className="space-y-4 mb-8">
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-emerald-600" />
                    <span className="text-gray-700 font-sans">Création de votre propre communauté d'énergie</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-emerald-600" />
                    <span className="text-gray-700 font-sans">Partage d'énergie entre vos propres bâtiments</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-emerald-600" />
                    <span className="text-gray-700 font-sans">Accompagnement technique et réglementaire</span>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-3xl p-10 border border-amber-100 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
                <div className="flex items-center mb-8">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-2 font-sans">Plateforme de gestion et monitoring</h3>
                    <div className="w-12 h-1 bg-gradient-to-r from-amber-500 to-orange-600 rounded-full"></div>
                  </div>
                </div>
                <p className="text-gray-700 text-lg leading-relaxed mb-8 font-sans font-light">
                  Plateforme de gestion et de monitoring pour vos projets de partage d'énergie avec suivi en temps réel et optimisation continue.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="bg-white p-4 rounded-xl border border-amber-200 text-center">
                    ...
                    <p className="text-sm font-medium text-gray-900 font-sans">Monitoring temps réel</p>
                  </div>
                  <div className="bg-white p-4 rounded-xl border border-amber-200 text-center">
                    <TrendingUp className="w-8 h-8 text-amber-600 mx-auto mb-2" />
                    <p className="text-sm font-medium text-gray-900 font-sans">Optimisation continue</p>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-3xl p-10 border border-purple-100 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
                <div className="flex items-center mb-8">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-2 font-sans">Optimisation de votre situation énergétique</h3>
                    <div className="w-12 h-1 bg-gradient-to-r from-purple-500 to-violet-600 rounded-full"></div>
                  </div>
                </div>
                <p className="text-gray-700 text-lg leading-relaxed mb-8 font-sans font-light">
                  Étude et installation de panneaux solaires, stockage d'énergie et optimisation complète de votre situation énergétique.
                </p>
                
                <div className="space-y-4 mb-8">
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-purple-600" />
                    <span className="text-gray-700 font-sans">Étude de rentabilité personnalisée</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-purple-600" />
                    <span className="text-gray-700 font-sans">Installation panneaux solaires et batteries</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-purple-600" />
                    <span className="text-gray-700 font-sans">Optimisation contrat et factures</span>
                  </div>
                </div>
            ...
            <div className="text-center mt-16">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 max-w-3xl mx-auto">
                ...
                <p className="text-gray-700 text-lg leading-relaxed font-sans font-light">
                  Nos quatre services se complètent pour offrir une solution énergétique complète. Que vous souhaitiez rejoindre notre communauté d'énergie mère, créer votre propre sous-communauté, utiliser notre plateforme de monitoring ou optimiser votre situation énergétique, nous vous accompagnons à chaque étape de votre transition énergétique.
                </p>
              </div>
            </div>
          </div>
