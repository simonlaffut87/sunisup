          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 items-center">
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-10 border border-gray-100 hover:shadow-3xl transition-all duration-300">
              <div className="text-center mb-8">
                ...
                <h3 className="text-3xl font-bold text-gray-900 mb-3">{t('about.whoAreWe.thomas.title')}</h3>
                <p className="text-blue-600 font-semibold text-lg">{t('about.whoAreWe.thomas.role')}</p>
              </div>
                  ...
                  <div key={index} className="flex items-start space-x-4">
                    ...
                    <div>
                      {qualification.includes('\n') ? (
                        <div>
                          <p className="font-bold text-gray-900 text-lg">{qualification.split('\n')[0]}</p>
                          <p className="text-gray-600 mt-2">{qualification.split('\n')[1]}</p>
                        </div>
                      ) : (
                        <p className="text-gray-700"><strong className="text-gray-900">{qualification.split(' - ')[0]}</strong> - {qualification.split(' - ')[1]}</p>
                      )}
                    </div>
                  </div>
                ))}
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-10 border border-gray-100 hover:shadow-3xl transition-all duration-300">
              <div className="text-center mb-8">
                ...
                <h3 className="text-3xl font-bold text-gray-900 mb-3">{t('about.whoAreWe.simon.title')}</h3>
                <p className="text-amber-600 font-semibold text-lg">{t('about.whoAreWe.simon.role')}</p>
              </div>
          ...
          <div className="mt-20 max-w-5xl mx-auto">
            <div className="bg-gradient-to-r from-blue-50 via-white to-amber-50 rounded-3xl p-12 border border-gray-100 shadow-xl">
              <div className="text-center mb-8">
                ...
                <h3 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">{t('about.whoAreWe.friendship.title')}</h3>
              </div>
              ...
              <div className="bg-white rounded-3xl p-12 shadow-2xl border border-gray-100">
                <div className="grid grid-cols-2 gap-8">
                  <div className="text-center">
                    ...
                    <h3 className="text-3xl font-bold text-gray-900 mb-3">724</h3>
                    <p className="text-gray-600 font-medium">{t('about.mission.stats.availableEnergy')}</p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="text-3xl font-bold text-gray-900 mb-3">11</h3>
                    <p className="text-gray-600 font-medium">{t('about.mission.stats.activeMembers')}</p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="text-3xl font-bold text-gray-900 mb-3">10%</h3>
                    <p className="text-gray-600 font-medium">{t('about.mission.stats.averageSavings')}</p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="text-3xl font-bold text-gray-900 mb-3">100%</h3>
                    <p className="text-gray-600 font-medium">{t('about.mission.stats.localEnergy')}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-12 lg:p-16 border border-gray-100">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="text-center">
                ...
                <h4 className="text-2xl font-bold text-gray-900 mb-4">Brugel</h4>
                <p className="text-gray-600 text-lg leading-relaxed">
              ...
              <div className="text-center">
                ...
                <h4 className="text-2xl font-bold text-gray-900 mb-4">Sibelga</h4>
                <p className="text-gray-600 text-lg leading-relaxed">
      ...
      <section className="py-20 bg-gradient-to-r from-amber-500 via-orange-500 to-red-500 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <a 
              href="/admin"
              className="bg-white hover:bg-gray-50 text-gray-900 px-10 py-4 rounded-full font-bold transition-all duration-200 shadow-2xl hover:shadow-3xl hover:scale-105 flex items-center gap-3 justify-center text-lg"
            >
            ...
            <a 
              href="/simulation"
              className="border-2 border-white/50 hover:bg-white hover:text-gray-900 text-white px-10 py-4 rounded-full font-bold transition-all duration-200 backdrop-blur-sm flex items-center gap-3 justify-center text-lg"
            >
