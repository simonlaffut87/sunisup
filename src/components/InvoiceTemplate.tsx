...
// Export function to generate PDF programmatically using React rendering
export async function generateInvoicePDF(
  ...
  try {
    ...
    // Create a promise that resolves when the invoice is ready
    return new Promise((resolve, reject) => {
      ...
      setTimeout(async () => {
        try {
          const invoiceElement = container.querySelector('#invoice-content') as HTMLElement;
